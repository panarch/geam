...
-> Result<HostProviderModule<Profile>, HostRegistrationError> {
    HostProviderModule::new("gleam_erlang", "gleam/erlang/atom")
        ...
        .and_then(|module| module.with_scoped_function::<Component<Profile>, (StringValue,), Atom, _>("create", create::<Profile>))
        .and_then(|module| module.with_scoped_function_and_constructions::<Component<Profile>, (StringValue,), GleamResult<Atom, ()>, HostTypeList<Atom, HostTypeListEnd>, _>("get", get::<Profile>))
        .and_then(|module| module.with_scoped_function::<Component<Profile>, (Atom,), StringValue, _>("to_string", to_string::<Profile>))
...
fn to_string<'call, Profile: GleamErlangHostProfile>(
    call: HostCall<'call, Profile, Component<Profile>, StringValue>,
