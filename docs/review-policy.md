...
Owner unit tests must keep representative inputs and exact expected results in
the owning test module. Do not use external fixtures or snapshots as owner unit
