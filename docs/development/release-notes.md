...
not apply. Add the new version to `docs/releases/README.md` so repository readers
can find it. Notes are written and reviewed by people, not generated from commit
