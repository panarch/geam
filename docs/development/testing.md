...
The callable consumer starts with CRLF Rust files on every platform. Sync
recognizes generated ownership markers with LF or CRLF line endings and writes
canonical LF output; check still requires exact generated bytes.
