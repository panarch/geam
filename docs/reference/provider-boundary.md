...
[`tests/fixtures/provider_sdk/runner/tests/public_usage.rs`](https://github.com/panarch/geam/blob/main/tests/fixtures/provider_sdk/runner/tests/public_usage.rs).
