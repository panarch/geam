...
fn prepare(
    ...
    let generated = generate(package, program, read_project)?;
...
fn generate_with_project_reader(
    ...
    generate(package, program, read_project)
}
...
#[cfg(test)]
mod tests {
    use super::{check, init, init_with_progress, prepare, report, sync, sync_with_project_reader};
