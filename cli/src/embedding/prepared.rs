...
impl Preparation {
    ...
    fn generate_in(
        ...
        Ok(self.artifact.render(
            ...
            &provenance::fingerprint(package, &metadata)?,
            &expression,
        ))
    }
}
...
mod tests {
    ...
    #[test]
    fn renders_readable_artifacts_with_an_input_fingerprint() {
        let fingerprint = "sha256:8c495a8671ca6847452e255c0770e5587c7c4832130c2a8ac4573416108d8ed8";
        for (artifact, declaration) in [
            ...
            let generated =
                artifact.render("runtime", fingerprint, "data::Example {\n    value: 42,\n}");
            assert_eq!(
                generated,
                r#"
...
// Preparation inputs: sha256:8c495a8671ca6847452e255c0770e5587c7c4832130c2a8ac4573416108d8ed8
"#
                .trim_start_matches('\n')
