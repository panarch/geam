use geam::{
    HostModule, HostModules, HostRegistrationError, HostedExecution, ModuleSource, PackageSource,
...
"#;
    ...
    let expected_explanation = r#"module main
main tuple#0
...
"#;
    ...
    assert_eq!(execution.explain().to_string(), expected_explanation);
}
