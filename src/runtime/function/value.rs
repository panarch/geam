...
use crate::plan::execution::function::{
    BitArrayFunctionId, BoolFunctionBody, BoolFunctionId, CustomFunctionId, ExecutableFunction,
    FloatFunctionId, IntFunctionBody, IntFunctionId, NeverFunctionId, NilFunctionId,
    StringFunctionId, TupleFunctionId, UtfCodepointFunctionId, ValueFunctionEntry,
};
    ...
    for ValueFunctionEntry<IntFunctionBody, HostIntFunctionId>
{
        ...
        >,
    {
        match self {
            ...
            ValueFunctionEntry::Host(target) => Ok(super::EvaluatedFunctionExit::Return(
...
pub(in crate::runtime) trait RuntimeBoolFunction<Plan: RuntimeExecutionPlan> {
    fn evaluate<EvaluateGraph>(
        ...
        inputs: RetainedValues,
        evaluate_graph: EvaluateGraph,
    ) -> ExecutionResult<super::EvaluatedFunctionExit<bool, BoolFunctionId>>
    where
        EvaluateGraph: FnOnce(
            &Plan,
            &mut RuntimeState,
            ...
            super::EvaluatedFunctionExit<bool, BoolFunctionId>,
        >;
...
#[cfg(test)]
mod tests {
    use super::{RuntimeBoolFunction as _, RuntimeIntFunction as _};
