...
pub(in crate::gleam_stdlib::string) fn grapheme_slice(
    string: EcoString,
    index: BigInt,
    length: BigInt,
...
pub(in crate::gleam_stdlib::string) fn unsafe_byte_slice(
    string: EcoString,
    index: BigInt,
    length: BigInt,
) -> Result<EcoString, HostFailure> {
...
pub(in crate::gleam_stdlib::string) fn erl_split<'call, Profile>(
...
pub(in crate::gleam_stdlib::string) fn erl_trim<'call, Profile>(
