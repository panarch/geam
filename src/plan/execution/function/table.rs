...
pub(in crate::plan::execution) struct HostedFunctionTablesExplanation<'a> {
    ...
    >,
    int_functions: &'a [HostedIntFunction],
    bool_functions: &'a [HostedBoolFunction],
}
            ...
            match function {
                ...
                ValueFunctionEntry::Host(target) => {
                    write_hosted_function(
                        ...
                        "int",
                        index,
                        &self.int_functions[target.index()],
                    );
                }
            }
        }
            ...
            match function {
                ...
                ValueFunctionEntry::Host(target) => {
                    write_hosted_function(
                        ...
                        "bool",
                        index,
                        &self.bool_functions[target.index()],
                    );
                }
            }
        }
...
"#;
        ...
        context.write(&HostedFunctionTablesExplanation::new(
            ...
            &execution.host_int_functions,
            &execution.host_bool_functions,
        ));
