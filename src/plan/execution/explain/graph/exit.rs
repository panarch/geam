use super::super::super::{
    ...
    FloatFunctionId, FloatListFunctionId, FunctionGraphExit, FunctionListFunctionId,
    GenericFunctionFunctionId, IntFunctionFunctionId, IntFunctionId, IntListFunctionId,
    ListFunctionFunctionId, ListListFunctionId, NeverFunctionFunctionId, NeverFunctionId,
...
pub(super) trait TailFunctionIndex {
...
pub(super) fn write_function_exit<Return, TailCall>(
    output: &mut String,
