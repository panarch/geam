use super::super::super::{
    ...
    NilFunctionId, NilListFunctionId, ParamLocal, ParameterListFunctionId,
    ParameterListListFunctionId, StringFunctionId, StringListFunctionId, TupleFunctionId,
...
pub(super) trait ExplainFunctionId {
...
pub(super) fn write_constant<Value>(output: &mut String, family: &str, id: ConstantId<Value>) {
...
mod tests {
    ...
    fn assert_function(function: &impl ExplainFunctionId, expected: &str) {
        ...
        function.label().push_to(&mut output);
