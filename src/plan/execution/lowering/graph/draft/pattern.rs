...
pub(in crate::plan::execution::lowering) struct DraftMatchPatternBinding {
    pub(in crate::plan::execution::lowering::graph) value: DraftValueRef,
    pub(in crate::plan::execution::lowering::graph) index: usize,
}
...
pub(in crate::plan::execution::lowering) struct DraftBitArrayPattern {
    pub(in crate::plan::execution::lowering::graph) segments: Vec<DraftBitArrayPatternSegment>,
}
...
pub(in crate::plan::execution::lowering) struct DraftBitArrayPatternSize {
    pub(in crate::plan::execution::lowering::graph) value: DraftBitArrayPatternSizeExpr,
