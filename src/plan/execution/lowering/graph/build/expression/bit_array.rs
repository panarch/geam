...
use crate::plan::execution::lowering::graph::draft::instruction::{
    DraftBitArrayBitsSize, DraftBitArrayEvaluatedSize, DraftBitArraySegment,
};
use crate::plan::execution::lowering::graph::{DraftBitArray, DraftCursor, DraftFlow, DraftGraph};
...
pub(in crate::plan::execution::lowering) fn bit_array_expr(
    ...
    match expression.kind() {
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor.scope().bit_array(super::super::local::LocalKey::new(
