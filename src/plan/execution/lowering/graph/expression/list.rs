...
use crate::plan::execution::lowering::graph::{
    ...
    DraftNilList, DraftStoredList, DraftString, DraftStringList, DraftTuple, DraftTupleList,
    DraftTypedList, DraftUtfCodepoint, DraftUtfCodepointList, DraftValueRef,
};
    ...
    module::ListItem<Function = module::FunctionInstantiation, IndexSource = module::ListListExpr>
{
    ...
    fn local_key(local: &<Self as module::ListItem>::Local)
    -> super::super::super::local::LocalKey;
    ...
    fn list_type(&self, context: &mut super::super::super::LoweringContext) -> Self::ExecutionType;
...
fn generic_list_operation(
    ...
    match item {
        ...
        SpecializedValueShape::List(item) => match item.storage_representation() {
            super::super::super::specialization::StorageRepresentation::Parameter(parameter) => {
                I::ParameterList(
                    context.parameter_list_list_type(parameter),
                    typed_generic_list_operation(operation),
                )
            }
            super::super::super::specialization::StorageRepresentation::Stored(item) => I::List(
...
pub(in crate::plan::execution::lowering) fn generic_list_expr(
    ...
    match item.storage_representation() {
        ...
        super::super::super::specialization::StorageRepresentation::Stored(item) => {
...
fn parameter_list_kind(
    ...
    match kind {
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor
                .scope()
                .list(super::super::super::local::LocalKey::new(
                    super::super::super::local::LocalKind::GenericList,
                    local.0,
                ));
            Representability::Inhabited(DraftFlow::value(cursor, value))
        }
...
fn typed_generic_list_value(
    ...
    match item {
        ...
        StoredValueShape::List(inner) => match inner.storage_representation() {
            ...
            super::super::super::specialization::StorageRepresentation::Stored(inner) => I::List(
...
fn stored_generic_list_constant(
    ...
    match item {
        ...
        StoredValueShape::List(inner) => match inner.storage_representation() {
            ...
            super::super::super::specialization::StorageRepresentation::Stored(inner) => {
    ...
    match kind {
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor
                .scope()
                .list(super::super::super::local::LocalKey::new(
                    super::super::super::local::LocalKind::ListList,
                    local.0,
                ));
            Representability::Inhabited(DraftFlow::value(cursor, value))
        }
    ...
    (
        ...
        impl GraphListItem for $module_item {
            ...
            fn local_key(
                ...
                super::super::super::local::LocalKey::new(
...
impl GraphListItem for module::CustomListItem {
    ...
    fn local_key(
        ...
        super::super::super::local::LocalKey::new(
            super::super::super::local::LocalKind::CustomList,
            local.0,
        )
    }
...
impl GraphListItem for module::TupleListItem {
    ...
    fn local_key(
        ...
        super::super::super::local::LocalKey::new(
            super::super::super::local::LocalKind::TupleList,
            local.0,
        )
    }
...
impl GraphListItem for module::FunctionListItem {
    ...
    fn local_key(
        ...
        super::super::super::local::LocalKey::new(
            super::super::super::local::LocalKind::FunctionList,
            local.0,
        )
    }
