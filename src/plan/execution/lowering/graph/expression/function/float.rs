...
pub(in crate::plan::execution::lowering) fn float_function_expr(
    ...
    match expression.kind() {
        ...
        E::Reference(value) => context
            ...
            .map(|target| {
                reference(shape.clone(), FunctionTarget::Float(target), cursor, graph)
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor
                ...
                .function(super::super::super::super::local::LocalKey::new(
                    super::super::super::super::local::LocalKind::FloatFunction,
                    local.0,
                ));
        ...
        E::Call {
            ...
            DraftFlow::Value {
                ...
                .map(|function| {
                    let function = execution::FunctionFunctionId::Float(function);
                    let value = graph.function_instruction(
                        &mut cursor,
                        shape.clone(),
