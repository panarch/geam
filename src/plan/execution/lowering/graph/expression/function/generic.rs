...
where
    ...
    Constant: Copy
        + Fn(
            ...
            &mut super::super::super::super::LoweringContext,
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor
                ...
                .function(super::super::super::super::local::LocalKey::new(
                    super::super::super::super::local::LocalKind::GenericFunction,
                    local.id().0,
                ));
                ...
                E::LocalGet { local, name: _ } => {
                    let value =
                        cursor
                            .scope()
                            .function(super::super::super::super::local::LocalKey::new(
                                super::super::super::super::local::LocalKind::$local_kind,
                                local.0,
                            ));
...
fn symbolic_list_kind(
    ...
    match kind {
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor.scope().function(
                super::super::super::super::local::list_function_local_key(local),
            );
            Representability::Inhabited(DraftFlow::value(cursor, DraftGenericFunction::new(value)))
        }
        E::Call { function, args, .. } => {
    ...
    match kind {
        ...
        E::LocalGet { local, name: _ } => {
            let value = cursor
                .scope()
                .function(super::super::super::super::local::LocalKey::new(
                    super::super::super::super::local::LocalKind::FunctionFunction,
                    local.id().0,
                ));
            Representability::Inhabited(DraftFlow::value(cursor, DraftGenericFunction::new(value)))
        }
...
mod tests {
    ...
    use crate::plan::execution::lowering::graph::{
        DraftFlow, DraftGenericFunction, DraftGraph, DraftGraphBuilder, DraftValueRef,
    };
