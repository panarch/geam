...
pub(in crate::plan::execution::lowering) fn bool_function_expr(
    ...
    let kind = match kind {
        ...
        M::Closure {
            ...
            params,
            captures,
            |id| execution::BoolFunctionId(id.0),
        )),
        ...
        M::BoolCase {
            ...
            true_: Box::new(bool_function_expr(*true_)),
            false_: Box::new(bool_function_expr(*false_)),
        },
        M::IntCase {
            subject,
            clauses,
            ...
            clauses: clauses
                .into_iter()
                .map(|(pattern, branch)| (pattern, bool_function_expr(branch)))
                .collect(),
            fallback: Box::new(bool_function_expr(*fallback)),
        },
        M::StringCase {
            subject,
            clauses,
        ...
        M::Block { steps, return_ } => E::Block {
            ...
            return_: Box::new(bool_function_expr(*return_)),
        },
    };
