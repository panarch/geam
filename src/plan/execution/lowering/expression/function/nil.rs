...
pub(in crate::plan::execution::lowering) fn nil_function_expr(
    ...
    let kind = match kind {
        ...
        M::Closure {
            ...
            params,
            captures,
            |id| execution::NilFunctionId(id.0),
        )),
        ...
        M::BoolCase {
            ...
            true_: Box::new(nil_function_expr(*true_)),
            false_: Box::new(nil_function_expr(*false_)),
        },
        M::IntCase {
            subject,
            clauses,
            ...
            clauses: clauses
                .into_iter()
                .map(|(pattern, branch)| (pattern, nil_function_expr(branch)))
                .collect(),
            fallback: Box::new(nil_function_expr(*fallback)),
        },
        M::StringCase {
            subject,
            clauses,
        ...
        M::Block { steps, return_ } => E::Block {
            ...
            return_: Box::new(nil_function_expr(*return_)),
        },
    };
