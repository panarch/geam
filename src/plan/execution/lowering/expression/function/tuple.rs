...
pub(in crate::plan::execution::lowering) fn tuple_function_expr(
    ...
    let kind = match kind {
        ...
        M::Closure {
            ...
            params,
            captures,
            |id| execution::TupleFunctionId(id.0),
        )),
        ...
        M::BoolCase {
            ...
            true_: Box::new(tuple_function_expr(*true_)),
            false_: Box::new(tuple_function_expr(*false_)),
        },
        M::IntCase {
            subject,
            clauses,
            ...
            clauses: clauses
                .into_iter()
                .map(|(pattern, branch)| (pattern, tuple_function_expr(branch)))
                .collect(),
            fallback: Box::new(tuple_function_expr(*fallback)),
        },
        M::StringCase {
            subject,
            clauses,
        ...
        M::Block { steps, return_ } => E::Block {
            ...
            return_: Box::new(tuple_function_expr(*return_)),
        },
    };
