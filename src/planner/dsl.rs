...
pub(crate) use expression::{
    ...
    call_int_returning_function, call_nil, call_string, capture_int, equal, evaluate_step,
    function_function_closure, function_function_ref, function_ref, int, int_arg, int_case_bool,
    int_case_int, int_case_int_function, int_case_nil, int_case_string, int_function_arg,
