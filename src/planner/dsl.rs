...
pub(crate) use function::{
    ...
    bool_function_return_int_case, bool_function_return_tail_call, bool_return_block,
    bool_return_bool_case, bool_return_expr, bool_return_int_case, bool_return_tail_call, function,
    function_function_return_block, function_function_return_expr,
    function_function_return_int_case, function_function_return_tail_call,
    ...
    nil_function_return_int_case, nil_function_return_tail_call, nil_return_block,
    nil_return_bool_case, nil_return_expr, nil_return_int_case, nil_return_tail_call,
    ...
    string_function_return_expr, string_function_return_int_case, string_function_return_tail_call,
    string_return_block, string_return_bool_case, string_return_expr, string_return_int_case,
