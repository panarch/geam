...
mod tests {
    use super::{
        ...
        int_case_nil_function, int_case_string, int_case_string_function, string_case_bool,
        string_case_bool_function, string_case_function_function, string_case_int,
        string_case_int_function, string_case_nil, string_case_nil_function, string_case_string,
