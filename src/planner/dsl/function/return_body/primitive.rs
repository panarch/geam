use crate::plan::{
    BoolFunctionId, BoolReturn, CallArg, IntFunctionId, IntReturn, NilFunctionId, NilReturn,
    ReturnBody, Step, StringFunctionId, StringReturn,
};
...
mod tests {
    use super::{
        bool_return_block, bool_return_bool_case, bool_return_expr, bool_return_int_case,
        bool_return_string_case, bool_return_tail_call, int_return_block, int_return_bool_case,
        int_return_expr, int_return_int_case, int_return_string_case, int_return_tail_call,
        nil_return_block, nil_return_bool_case, nil_return_expr, nil_return_int_case,
        nil_return_string_case, nil_return_tail_call, string_return_block, string_return_bool_case,
        string_return_expr, string_return_int_case, string_return_string_case,
