...
//   block b1 params=[]
//     %bool#0:shape#3(Bool) = bool.value False
//     match %bool#0 pattern=False success=b2() failure=b7(%bool#0)
//   block b2 params=[]
//     %nil#0:shape#4(Nil) = nil.value
//     %int#0:shape#0(Int) = int.value 1
//     %float#0:shape#5(Float) = float.value 1.5
//     %string#0:shape#1(String) = string.value "ready"
//     %bool#0:shape#3(Bool) = bool.value False
//     %int#1:shape#0(Int) = int.value 2
//     %int#2:shape#0(Int) = int.value 3
//     %list.int#0:shape#2(list_type#0) = list.int[type#0] value elements=[%int#1, %int#2]
//     %int#3:shape#0(Int) = int.value 4
//     %int#4:shape#0(Int) = int.value 5
//     %list.int#1:shape#2(list_type#0) = list.int[type#0] value elements=[%int#3, %int#4]
//     %int#5:shape#0(Int) = int.value 6
//     %string#1:shape#1(String) = string.value "prefix"
//     %int#6:shape#0(Int) = int.value 7
//     %list.int#2:shape#2(list_type#0) = list.int[type#0] value elements=[%int#6]
...
//   block b3 params=[%int#0:shape#0(Int), %int#1:shape#0(Int), %int#2:shape#0(Int), %list.int#0:shape#2(list_type#0), %int#3:shape#0(Int), %string#0:shape#1(String), %string#1:shape#1(String), %int#4:shape#0(Int), %tuple#0:shape#7(#(Int, Float, String, Bool, list_type#0, list_type#0, custom_type#0))]
//     %int#5:shape#0(Int) = int.value 8
//     %int#6:shape#0(Int) = int.value -2
//     %int#7:shape#0(Int) = int.value 564
//     %int#8:shape#0(Int) = int.value 16
//     %int#9:shape#0(Int) = int.value 1
//     %int#10:shape#0(Int) = int.value 9
//     %int#11:shape#0(Int) = int.value 8
//     %int#12:shape#0(Int) = int.value 2
//     %float#0:shape#5(Float) = float.value 1.5
//     %float#1:shape#5(Float) = float.value 1.5
//     %float#2:shape#5(Float) = float.value 1.5
//     %string#2:shape#1(String) = string.value "A"
//     %string#3:shape#1(String) = string.value "A"
//     %string#4:shape#1(String) = string.value "B"
//     %string#5:shape#1(String) = string.value "A"
//     %string#6:shape#1(String) = string.value "C"
//     %string#7:shape#1(String) = string.value "D"
//     %string#8:shape#1(String) = string.value "E"
//     %string#9:shape#1(String) = string.value "F"
//     %int#13:shape#0(Int) = int.value 1
//     %int#14:shape#0(Int) = int.value 2
//     %int#15:shape#0(Int) = int.value 3
//     %int#16:shape#0(Int) = int.value 5
//     %int#17:shape#0(Int) = int.value 6
//     %int#18:shape#0(Int) = int.value 7
//     %int#19:shape#0(Int) = int.value 8
//     %int#20:shape#0(Int) = int.value 4
...
//   block b4 params=[%int#0:shape#0(Int), %int#1:shape#0(Int), %int#2:shape#0(Int), %int#3:shape#0(Int), %float#0:shape#5(Float), %float#1:shape#5(Float), %utf_codepoint#0:shape#9(UtfCodepoint), %utf_codepoint#1:shape#9(UtfCodepoint), %bit_array#0:shape#8(BitArray), %bit_array#1:shape#8(BitArray), %bit_array#2:shape#8(BitArray), %bit_array#3:shape#8(BitArray), %int#4:shape#0(Int), %int#5:shape#0(Int), %int#6:shape#0(Int), %list.int#0:shape#2(list_type#0), %int#7:shape#0(Int), %string#0:shape#1(String), %string#1:shape#1(String), %int#8:shape#0(Int), %tuple#0:shape#7(#(Int, Float, String, Bool, list_type#0, list_type#0, custom_type#0))]
...
//   block b7 params=[%bool#0:shape#3(Bool)]
//     let_assert_panic subject=%bool#0 message=none
//   block b8 params=[%bool#0:shape#3(Bool)]
//     let_assert_panic subject=%bool#0 message=none
