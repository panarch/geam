...
//
// function float#0
//   entry b0 params=[%float#0:shape#2(Float)] captures=[]
//   block b0 params=[%float#0:shape#2(Float)]
//     return %float#0
//
// function string#0
//   entry b0 params=[%string#0:shape#3(String)] captures=[]
//   block b0 params=[%string#0:shape#3(String)]
//     return %string#0
//
...
//   entry b0 params=[%utf_codepoint#0:shape#5(UtfCodepoint)] captures=[]
//   block b0 params=[%utf_codepoint#0:shape#5(UtfCodepoint)]
...
//   block b1 params=[%utf_codepoint#0:shape#5(UtfCodepoint)]
//     return %utf_codepoint#0
...
//
// function bool#0
//   entry b0 params=[%bool#0:shape#6(Bool)] captures=[]
//   block b0 params=[%bool#0:shape#6(Bool)]
//     return %bool#0
//
// function nil#0
//   entry b0 params=[%nil#0:shape#7(Nil)] captures=[]
//   block b0 params=[%nil#0:shape#7(Nil)]
//     return %nil#0
//
// function tuple#0
//   entry b0 params=[] captures=[]
//   block b0 params=[]
//     %function.int#0:shape#9(fn(Int) -> Int) = function[Int] reference int#0
//     %function.float#0:shape#10(fn(Float) -> Float) = function[Float] reference float#0
//     %function.string#0:shape#11(fn(String) -> String) = function[String] reference string#0
//     %function.bit_array#0:shape#12(fn(BitArray) -> BitArray) = function[BitArray] reference bit_array#0
//     %function.utf_codepoint#0:shape#13(fn(UtfCodepoint) -> UtfCodepoint) = function[UtfCodepoint] reference utf_codepoint#0
//     %function.custom#0:shape#14(fn(custom_type#0) -> custom_type#0) = function[Custom] reference custom#0
//     %function.bool#0:shape#15(fn(Bool) -> Bool) = function[Bool] reference bool#0
//     %function.nil#0:shape#16(fn(Nil) -> Nil) = function[Nil] reference nil#0
//     %function.tuple#0:shape#17(fn(#(Int)) -> #(Int)) = function[Tuple] reference tuple#1
//     %utf_codepoint#0:shape#5(UtfCodepoint) = utf_codepoint.call utf_codepoint#1 args=[]
//     %int#0:shape#1(Int) = int.value 1
//     %float#0:shape#2(Float) = float.value 1.5
//     %string#0:shape#3(String) = string.value "one"
//     %int#1:shape#1(Int) = int.value 1
//     %bit_array#0:shape#4(BitArray) = bit_array.value [int(%int#1, bits=8, big)]
//     %bool#0:shape#6(Bool) = bool.value True
//     %nil#0:shape#7(Nil) = nil.value
//     %int#2:shape#1(Int) = int.value 1
//     %tuple#0:shape#8(#(Int)) = tuple.value elements=[%int#2]
...
//     %float#1:shape#2(Float) = float.value 1.5
//     %string#1:shape#3(String) = string.value "one"
//     %int#4:shape#1(Int) = int.value 1
//     %bit_array#1:shape#4(BitArray) = bit_array.value [int(%int#4, bits=8, big)]
//     %bool#1:shape#6(Bool) = bool.value True
//     %nil#1:shape#7(Nil) = nil.value
//     %int#5:shape#1(Int) = int.value 1
//     %tuple#1:shape#8(#(Int)) = tuple.value elements=[%int#5]
...
//     %string#2:shape#3(String) = string.value "prefix-tail"
...
//   block b2 params=[%function.int#0:shape#9(fn(Int) -> Int), %function.float#0:shape#10(fn(Float) -> Float), %function.string#0:shape#11(fn(String) -> String), %function.bit_array#0:shape#12(fn(BitArray) -> BitArray), %function.utf_codepoint#0:shape#13(fn(UtfCodepoint) -> UtfCodepoint), %function.custom#0:shape#14(fn(custom_type#0) -> custom_type#0), %function.bool#0:shape#15(fn(Bool) -> Bool), %function.nil#0:shape#16(fn(Nil) -> Nil), %function.tuple#0:shape#17(fn(#(Int)) -> #(Int)), %utf_codepoint#0:shape#5(UtfCodepoint), %custom#0:shape#18(custom_type#0), %tuple#0:shape#19(#(Int, Float, String, BitArray, UtfCodepoint, custom_type#0, Bool, Nil, #(Int))), %string#0:shape#3(String), %string#1:shape#3(String), %int#0:shape#1(Int), %int#1:shape#1(Int)]
...
//     %float#3:shape#2(Float) = float.value 3.0
//     %float#4:shape#2(Float) = float.value 4.0
//     %float#5:shape#2(Float) = float.mult %float#3 %float#4
//     %float#6:shape#2(Float) = float.value 5.0
//     %float#7:shape#2(Float) = float.div %float#5 %float#6
//     %float#8:shape#2(Float) = float.sub %float#2 %float#7
//     %string#2:shape#3(String) = string.value "one"
//     %string#3:shape#3(String) = string.value "two"
//     %string#4:shape#3(String) = string.concatenate %string#2 %string#3
//     %bool#0:shape#6(Bool) = bool.value False
//     %bool#1:shape#6(Bool) = bool.not %bool#0
//     %int#14:shape#1(Int) = int.value 1
//     %int#15:shape#1(Int) = int.value 2
//     %bool#2:shape#6(Bool) = bool.lt_int %int#14 %int#15
//     %int#16:shape#1(Int) = int.value 1
//     %int#17:shape#1(Int) = int.value 2
//     %bool#3:shape#6(Bool) = bool.lte_int %int#16 %int#17
//     %int#18:shape#1(Int) = int.value 2
//     %int#19:shape#1(Int) = int.value 1
//     %bool#4:shape#6(Bool) = bool.gt_int %int#18 %int#19
//     %int#20:shape#1(Int) = int.value 2
//     %int#21:shape#1(Int) = int.value 1
//     %bool#5:shape#6(Bool) = bool.gte_int %int#20 %int#21
//     %float#9:shape#2(Float) = float.value 1.0
//     %float#10:shape#2(Float) = float.value 2.0
//     %bool#6:shape#6(Bool) = bool.lt_float %float#9 %float#10
//     %float#11:shape#2(Float) = float.value 1.0
//     %float#12:shape#2(Float) = float.value 2.0
//     %bool#7:shape#6(Bool) = bool.lte_float %float#11 %float#12
//     %float#13:shape#2(Float) = float.value 2.0
//     %float#14:shape#2(Float) = float.value 1.0
//     %bool#8:shape#6(Bool) = bool.gt_float %float#13 %float#14
//     %float#15:shape#2(Float) = float.value 2.0
//     %float#16:shape#2(Float) = float.value 1.0
//     %bool#9:shape#6(Bool) = bool.gte_float %float#15 %float#16
//     %int#22:shape#1(Int) = int.value 1
//     %int#23:shape#1(Int) = int.value 1
//     %bool#10:shape#6(Bool) = bool.equal %int#22 %int#23
//     %int#24:shape#1(Int) = int.value 1
//     %int#25:shape#1(Int) = int.value 2
//     %bool#11:shape#6(Bool) = bool.not_equal %int#24 %int#25
...
//     %float#20:shape#2(Float) = float.function_call %function.float#0 args=[%float#19]
//     %string#5:shape#3(String) = string.value "one"
...
//     %bit_array#0:shape#4(BitArray) = bit_array.value [int(%int#30, bits=8, big)]
//     %bit_array#1:shape#4(BitArray) = bit_array.call bit_array#0 args=[%bit_array#0]
//     %int#31:shape#1(Int) = int.value 1
//     %bit_array#2:shape#4(BitArray) = bit_array.value [int(%int#31, bits=8, big)]
...
//     %bool#12:shape#6(Bool) = bool.value True
//     %bool#13:shape#6(Bool) = bool.call bool#0 args=[%bool#12]
//     %bool#14:shape#6(Bool) = bool.value True
//     %bool#15:shape#6(Bool) = bool.function_call %function.bool#0 args=[%bool#14]
//     %nil#0:shape#7(Nil) = nil.value
...
//     %tuple#1:shape#8(#(Int)) = tuple.value elements=[%int#32]
//     %tuple#2:shape#8(#(Int)) = tuple.call tuple#1 args=[%tuple#1]
//     %int#33:shape#1(Int) = int.value 1
//     %tuple#3:shape#8(#(Int)) = tuple.value elements=[%int#33]
...
//     %utf_codepoint#3:shape#5(UtfCodepoint) = utf_codepoint.tuple_index %tuple#0 index=4
...
//     %utf_codepoint#4:shape#5(UtfCodepoint) = utf_codepoint.custom_field %custom#0 index=4
...
//     %bit_array#6:shape#4(BitArray) = bit_array.value [int(%int#40, bits=8, big)]
//     %int#41:shape#1(Int) = int.value 2
//     %bit_array#7:shape#4(BitArray) = bit_array.value [int(%int#41, bits=8, big)]
//     %int#42:shape#1(Int) = int.value 3
//     %bit_array#8:shape#4(BitArray) = bit_array.value [int(%int#42, bits=8, big)]
...
//   block b5 params=[%string#0:shape#3(String)]
//     let_assert_panic subject=%string#0 message=none
//
// function tuple#1
//   entry b0 params=[%tuple#0:shape#8(#(Int))] captures=[]
//   block b0 params=[%tuple#0:shape#8(#(Int))]
//     return %tuple#0
