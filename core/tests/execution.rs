...
mod bindings {
    execution_cases!("bindings";
        ...
        custom_list_tail_alias_assignment,
...
mod execution_errors {
    ...
    mod functions {
        execution_error_cases!("functions";
            ...
            generic_never_static_bool_case,
            generic_tuple_never_static_bool_case,
            generic_custom_never_static_bool_case,
            generic_return_bool_case_subject,
            generic_list_return_bool_case_subject,
...
fn render_custom_type(type_: &geam_core::CustomType) -> String {
...
fn render_external_type(type_: &geam_core::ExternalType) -> String {
    let name = type_.type_name();
    let arguments = type_
        .arguments()
        .iter()
