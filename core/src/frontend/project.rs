...
use gleam_compiler_core::manifest::{Manifest, ManifestPackage, ManifestPackageSource};
use gleam_compiler_core::type_::PRELUDE_MODULE_NAME;
use gleam_compiler_core::warning::WarningEmitter;
...
pub enum ProjectError {
    ...
    IncompatibleCompilerVersion {
        package: EcoString,
        error: Box<gleam_compiler_core::Error>,
    },
