...
pub(super) fn plan_use_statement(
    use_: gleam_compiler_core::ast::TypedUse,
...
"#;
    ...
    fn reject_margin_use_call_shapes() {
        ...
        non_call_rhs.definitions.functions[0].body =
            vec![Statement::Use(gleam_compiler_core::ast::Use {
...
"#,
    ...
    fn expect_use_callback_function_mut(
        ...
        &mut Vec<gleam_compiler_core::ast::TypedArg>,
    ) {
