...
use gleam_compiler_core::ast::{
    AssignmentKind, Pattern, SrcSpan, TypedAssignment, TypedExpr, TypedPattern,
};
...
pub(super) fn is_total_binding_pattern(
    ...
    match pattern {
        ...
        Pattern::List { elements, tail, .. } => {
            ...
            match tail.as_deref() {
                Some(gleam_compiler_core::ast::TailPattern {
...
fn plan_total_bit_array_binding_pattern(
    segments: Vec<
        gleam_compiler_core::ast::BitArraySegment<
            TypedPattern,
    ...
    if !matches!(
        ...
        [gleam_compiler_core::ast::BitArrayOption::Bits { .. }]
    ) {
        return Err(PlanError::InvalidTypedAst {
            reason: InvalidTypedAstReason::PatternShape {
...
fn is_total_bit_array_binding(
    segments: &[gleam_compiler_core::ast::BitArraySegment<
        TypedPattern,
        std::sync::Arc<gleam_compiler_core::type_::Type>,
    >],
) -> bool {
...
fn plan_tail_only_list_binding_pattern_in_context(
    ...
    tail: Option<
        Box<
            gleam_compiler_core::ast::TailPattern<std::sync::Arc<gleam_compiler_core::type_::Type>>,
        >,
    >,
...
"#,
    ...
    fn custom_binding_pattern_requires_known_total_constructor_metadata() {
        ...
        let result_constructor = || gleam_compiler_core::type_::PatternConstructor {
            name: "Ok".into(),
            field_map: None,
            documentation: None,
            module: "gleam".into(),
        ...
        let pattern_constructor = || gleam_compiler_core::type_::PatternConstructor {
            name: "Choice".into(),
            field_map: None,
            documentation: None,
            module: "main".into(),
