...
use gleam_compiler_core::ast::{Statement, TypedAssert};
use vec1::Vec1;
...
pub(super) fn plan_steps_and_return(
    mut statements: Vec<gleam_compiler_core::ast::TypedStatement>,
...
pub(super) fn plan_non_empty_steps_and_return(
    statements: Vec1<gleam_compiler_core::ast::TypedStatement>,
    context: &mut PlanContext<'_>,
    expected_return_shape: Option<&ValueShape>,
) -> Result<PlannedStatements, PlanError> {
...
pub(super) fn plan_runtime_steps(
    statement: gleam_compiler_core::ast::TypedStatement,
    context: &mut PlanContext<'_>,
...
fn plan_ordered_steps_and_return(
    statements: Vec<gleam_compiler_core::ast::TypedStatement>,
    last_statement: gleam_compiler_core::ast::TypedStatement,
    context: &mut PlanContext<'_>,
    expected_return_shape: Option<&ValueShape>,
) -> Result<PlannedStatements, PlanError> {
...
mod tests {
    ...
    use gleam_compiler_core::ast::{Statement, TypedExpr};
...
"#,
    ...
    fn reject_margin_assert_condition_type_mismatch() {
        ...
        module.definitions.functions[0].body = vec![
            Statement::Assert(gleam_compiler_core::ast::Assert {
                location: dummy_span(),
    ...
    fn reject_margin_final_assert_condition_type_mismatch() {
        let mut module = compile_minimal_module();
        module.definitions.functions[0].body =
            vec![Statement::Assert(gleam_compiler_core::ast::Assert {
                location: dummy_span(),
                value: typed_int_expr(1),
                message: None,
            })];
    ...
    fn reject_margin_step_use_statement_shape() {
        ...
        step_use.definitions.functions[0].body = vec![
            Statement::Use(gleam_compiler_core::ast::Use {
    ...
    fn typed_bool_expr(value: bool) -> TypedExpr {
        ...
        use gleam_compiler_core::type_::{Deprecation, ValueConstructor, ValueConstructorVariant};
