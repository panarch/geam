...
use gleam_compiler_core::ast::{Pattern, TailPattern, TypedPattern};
use gleam_compiler_core::type_::{PRELUDE_MODULE_NAME, PatternConstructor, Type};
...
mod tests {
    ...
    use ecow::EcoString;
    use gleam_compiler_core::analyse::Inferred;
    use gleam_compiler_core::ast::{BitArraySize, CallArg, Pattern, TailPattern, TypedPattern};
    use gleam_compiler_core::type_::{self, PRELUDE_MODULE_NAME, PatternConstructor};
...
"#,
    ...
    fn scalar_and_tuple_helpers_preserve_structured_context() {
        ...
        assert_eq!(
            super::resolved_constructor(&gleam_compiler_core::analyse::Inferred::Unknown),
            Err(pattern_error(
