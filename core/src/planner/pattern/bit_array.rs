...
use gleam_compiler_core::type_::{Type, ValueConstructor, ValueConstructorVariant};
use std::sync::Arc;
...
mod tests {
    ...
    use gleam_compiler_core::ast::{BitArrayOption, BitArraySegment, Constant, Pattern};
...
"#,
    ...
    fn reject_margin_bit_array_pattern_invalid_typed_ast_shapes() {
        ...
        let alias =
            |name: &str, pattern: Pattern<std::sync::Arc<gleam_compiler_core::type_::Type>>| {
                Pattern::Assign {
                    name: name.into(),
                    location: dummy_span(),
                    pattern: Box::new(pattern),
        ...
        let int_size = || gleam_compiler_core::ast::BitArraySize::Int {
            location: dummy_span(),
            value: "1".into(),
            int_value: 1.into(),
        };
        let missing_constructor = || gleam_compiler_core::ast::BitArraySize::Variable {
            location: dummy_span(),
            name: "missing".into(),
            constructor: None,
            type_: type_::int(),
        ...
        cases.push((
            vec![segment(
                Pattern::Variable {
                    ...
                    name: "value".into(),
                    type_: type_::string(),
                    origin: gleam_compiler_core::type_::error::VariableOrigin::generated(),
                },
        ...
        for (value, options, type_, expected) in [
            ...
            (
                discard(type_::int()),
                vec![size(gleam_compiler_core::ast::BitArraySize::Variable {
                    location: dummy_span(),
                    name: "unknown".into(),
            ...
            (
                discard(type_::int()),
                vec![size(
                    gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                        location: dummy_span(),
                        operator: gleam_compiler_core::ast::IntOperator::Add,
    ...
    fn plan_bit_array_pattern_preserves_supported_segment_shapes() {
        ...
        let arithmetic_size = gleam_compiler_core::ast::BitArraySize::Block {
            location: dummy_span(),
            inner: Box::new(gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                location: dummy_span(),
                operator: gleam_compiler_core::ast::IntOperator::Add,
                left: Box::new(gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                    location: dummy_span(),
                    operator: gleam_compiler_core::ast::IntOperator::Subtract,
                    left: Box::new(gleam_compiler_core::ast::BitArraySize::Variable {
                        location: dummy_span(),
                        name: "int_size".into(),
                        constructor: Some(Box::new(local_constructor(type_::int()))),
                        type_: type_::int(),
                ...
                right: Box::new(gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                    location: dummy_span(),
                    operator: gleam_compiler_core::ast::IntOperator::Multiply,
                    left: Box::new(gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                        location: dummy_span(),
                        operator: gleam_compiler_core::ast::IntOperator::Divide,
                        left: Box::new(int_size()),
                        right: Box::new(int_size()),
                    }),
                    right: Box::new(gleam_compiler_core::ast::BitArraySize::BinaryOperator {
                        location: dummy_span(),
                        operator: gleam_compiler_core::ast::IntOperator::Remainder,
                        left: Box::new(int_size()),
                        right: Box::new(int_size()),
                    }),
                }),
