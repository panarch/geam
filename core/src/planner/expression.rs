...
use gleam_compiler_core::ast::TodoKind;
...
pub(super) fn plan_use_call(
    ...
    fun: TypedExpr,
    arguments: Vec<gleam_compiler_core::ast::CallArg<TypedExpr>>,
    context: &mut PlanContext<'_>,
) -> Result<Expr, PlanError> {
...
pub(in crate::planner::expression) fn module_returning_typed_expr(
    expression: TypedExpr,
) -> gleam_compiler_core::ast::TypedModule {
    let mut module = crate::planner::support::compile_minimal_module();
    module.definitions.functions[0].body =
        vec![gleam_compiler_core::ast::Statement::Expression(expression)];
    module
}
...
mod tests {
    ...
    use gleam_compiler_core::ast::{Constant, Statement, TypedExpr, TypedModule};
    use gleam_compiler_core::type_::{self, ModuleValueConstructor, Type};
    use num_bigint::BigInt;
        ...
        assert_eq!(
            super::plan_expr(
                TypedExpr::Todo {
                    location: dummy_span(),
                    type_: type_::string(),
                    kind: gleam_compiler_core::ast::TodoKind::Keyword,
                    message: None,
                },
                &mut context,
            ),
...
"#,
    ...
    fn reject_margin_source_stop_expression_shapes() {
        ...
        for kind in [
            gleam_compiler_core::ast::TodoKind::EmptyFunction {
                function_location: dummy_span(),
            },
            gleam_compiler_core::ast::TodoKind::EmptyBlock,
            gleam_compiler_core::ast::TodoKind::IncompleteUse,
        ] {
            assert_eq!(
                super::plan_expr(
                    TypedExpr::Todo {
