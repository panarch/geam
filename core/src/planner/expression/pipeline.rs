...
use gleam_compiler_core::ast::{
    PIPE_VARIABLE, PipelineAssignmentKind, TypedExpr, TypedPipelineAssignment,
};
use gleam_compiler_core::type_::ValueConstructor;
...
mod tests {
    ...
    use gleam_compiler_core::type_::{self, ValueConstructor, ValueConstructorVariant};
    use std::sync::Arc;
    use vec1::Vec1;
...
"#;
    ...
    fn compile_pipeline_module() -> gleam_compiler_core::ast::TypedModule {
        compile(
            r#"
fn add_one(value: Int) {
  value + 1
...
"#,
    ...
    fn compile_hole_pipeline_module() -> gleam_compiler_core::ast::TypedModule {
        compile(
            r#"
fn subtract(left: Int, right: Int) {
  left - right
