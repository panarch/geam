...
"#,
    ...
    fn reject_margin_utf_codepoint_case_pattern_shapes() {
        let type_ = utf_codepoint_type();
        assert_eq!(
            super::plan_case_pattern(gleam_compiler_core::ast::Pattern::Discard {
                location: dummy_span(),
                name: "_".into(),
                type_: type_.clone(),
            })
        ...
        assert_eq!(
            super::plan_case_pattern(gleam_compiler_core::ast::Pattern::Variable {
                location: dummy_span(),
                name: "value".into(),
        ...
        assert_eq!(
            super::plan_case_pattern(gleam_compiler_core::ast::Pattern::Assign {
                location: dummy_span(),
                name: "alias".into(),
                pattern: Box::new(gleam_compiler_core::ast::Pattern::Int {
                    location: dummy_span(),
                    value: "1".into(),
                    int_value: 1.into(),
                }),
        ...
        assert_eq!(
            super::plan_case_pattern(gleam_compiler_core::ast::Pattern::Invalid {
                location: dummy_span(),
                type_,
            }),
        ...
        assert_eq!(
            super::plan_case_pattern(gleam_compiler_core::ast::Pattern::Tuple {
                location: dummy_span(),
                elements: Vec::new(),
            }),
            Err(super::super::pattern_type_mismatch(
