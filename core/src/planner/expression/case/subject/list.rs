...
use ecow::EcoString;
use gleam_compiler_core::ast::{AssignName, Pattern, SrcSpan, TailPattern, TypedExpr};
...
mod tests {
    ...
    use gleam_compiler_core::ast::Pattern;
...
"#,
    ...
    fn reject_margin_list_case_pattern_mismatched_and_invalid_shapes() {
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Variable {
                    location: dummy_span(),
                    name: "value".into(),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Assign {
                    location: dummy_span(),
                    name: "alias".into(),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Discard {
                    location: dummy_span(),
                    name: "_".into(),
                    type_: gleam_compiler_core::type_::int(),
                },
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Int {
                    location: dummy_span(),
                    value: "1".into(),
                    int_value: num_bigint::BigInt::from(1),
                },
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Invalid {
                    location: dummy_span(),
                    type_: gleam_compiler_core::type_::list(gleam_compiler_core::type_::int()),
                },
                subject,
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                Pattern::List {
                    ...
                    tail: None,
                    type_: gleam_compiler_core::type_::list(gleam_compiler_core::type_::bit_array()),
                },
                Expr::list(
    ...
    fn reject_margin_list_structural_element_projection_type_mismatch() {
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    location: dummy_span(),
                    elements: vec![gleam_compiler_core::ast::Pattern::Discard {
                        location: dummy_span(),
                        name: "_".into(),
                        type_: gleam_compiler_core::type_::string(),
                    }],
                    tail: None,
                    type_: gleam_compiler_core::type_::list(gleam_compiler_core::type_::string()),
                },
                int_list_subject,
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::StringPrefix {
                    ...
                    right_side_assignment: gleam_compiler_core::ast::AssignName::Variable(
                        "name".into()
                    ),
                },
                value.clone(),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::StringPrefix {
                    ...
                    right_location: dummy_span(),
                    right_side_assignment: gleam_compiler_core::ast::AssignName::Discard(
                        "_rest".into()
                    ),
                },
    ...
    fn list_case_pattern_supports_literal_leaf_families() {
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Float {
                    location: dummy_span(),
                    value: "1.0".into(),
                    float_value: gleam_compiler_core::parse::LiteralFloatValue::ONE,
                },
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::String {
                    location: dummy_span(),
                    value: "one".into(),
                },
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Constructor {
                    location: dummy_span(),
                    ...
                    spread: None,
                    type_: gleam_compiler_core::type_::bool(),
                },
                bool_(true).into(),
                ValueType::Bool,
            ),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    ...
                    elements: Vec::new(),
                    tail: None,
                    type_: gleam_compiler_core::type_::list(
                        gleam_compiler_core::type_::generic_var(0)
                    ),
                },
                list_subject.clone(),
                list_type.clone(),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    location: dummy_span(),
                    elements: Vec::new(),
                    tail: Some(Box::new(gleam_compiler_core::ast::TailPattern {
                        location: dummy_span(),
                        pattern: gleam_compiler_core::ast::Pattern::Variable {
                            location: dummy_span(),
                            name: "rest".into(),
                            type_: gleam_compiler_core::type_::list(
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    ...
                    tail: Some(Box::new(gleam_compiler_core::ast::TailPattern {
                        location: dummy_span(),
                        pattern: gleam_compiler_core::ast::Pattern::Discard {
                            location: dummy_span(),
                            name: "_".into(),
                            type_: gleam_compiler_core::type_::list(
                                gleam_compiler_core::type_::int()
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    ...
                    tail: Some(Box::new(gleam_compiler_core::ast::TailPattern {
                        location: dummy_span(),
                        pattern: gleam_compiler_core::ast::Pattern::Invalid {
                            location: dummy_span(),
                            type_: gleam_compiler_core::type_::list(
                                gleam_compiler_core::type_::int()
                            ),
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::List {
                    ...
                    tail: Some(Box::new(gleam_compiler_core::ast::TailPattern {
                        location: dummy_span(),
                        pattern: gleam_compiler_core::ast::Pattern::Int {
                            location: dummy_span(),
                            value: "1".into(),
                            int_value: num_bigint::BigInt::from(1),
                        },
    ...
    fn list_tuple_case_pattern_combines_literal_match_conditions() {
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Tuple {
                    location: dummy_span(),
                    elements: vec![
                        gleam_compiler_core::ast::Pattern::Int {
                            location: dummy_span(),
    ...
    fn reject_margin_list_nested_tuple_pattern_shapes() {
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Tuple {
                    location: dummy_span(),
                    elements: vec![gleam_compiler_core::ast::Pattern::Tuple {
                        location: dummy_span(),
                        elements: Vec::new(),
                    }],
                },
    ...
    fn reject_margin_list_element_special_patterns_with_wrong_subject_shape() {
        ...
        assert_eq!(
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::BitArray {
                    location: dummy_span(),
                    segments: Vec::new(),
                },
...
"#,
    ...
    fn refutable_custom_list_element_keeps_match_without_total_binding_steps() {
        ...
        let mut anonymous = AnonymousFunctions::default();
        let mut context = PlanContext::new(&module_name, &functions, &mut anonymous);
        let ast_type = gleam_compiler_core::type_::result(
            gleam_compiler_core::type_::int(),
        ...
        let type_ = CustomType::new(
            CustomTypeName::new(
                "".into(),
                gleam_compiler_core::type_::PRELUDE_MODULE_NAME.into(),
                "Result".into(),
            ),
        ...
        let pattern = gleam_compiler_core::ast::Pattern::Constructor {
            location: dummy_span(),
            name_location: dummy_span(),
            name: "Ok".into(),
            arguments: vec![gleam_compiler_core::ast::CallArg {
                label: None,
                location: dummy_span(),
                value: gleam_compiler_core::ast::Pattern::Int {
                    location: dummy_span(),
                    value: "1".into(),
                    int_value: 1.into(),
                },
            ...
            module: None,
            constructor: gleam_compiler_core::analyse::Inferred::Known(
                gleam_compiler_core::type_::PatternConstructor {
                    name: "Ok".into(),
                    field_map: None,
                    documentation: None,
                    module: gleam_compiler_core::type_::PRELUDE_MODULE_NAME.into(),
                    location: dummy_span(),
                    constructor_index: 0,
                },
            ),
    ...
    fn custom_pattern_rejects_a_non_custom_projected_list_element() {
        let custom_type = gleam_compiler_core::type_::result(
            gleam_compiler_core::type_::int(),
            gleam_compiler_core::type_::string(),
        );
            ...
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Constructor {
                    ...
                    arguments: vec![gleam_compiler_core::ast::CallArg {
                        label: None,
                        location: dummy_span(),
                        value: gleam_compiler_core::ast::Pattern::Discard {
                            location: dummy_span(),
                            name: "_".into(),
                            type_: gleam_compiler_core::type_::int(),
                        },
                    ...
                    module: None,
                    constructor: known_constructor(
                        "Ok",
                        gleam_compiler_core::type_::PRELUDE_MODULE_NAME,
                        0,
                    ),
                    spread: None,
        ...
        let result_ast_type = gleam_compiler_core::type_::result(
            gleam_compiler_core::type_::int(),
            gleam_compiler_core::type_::string(),
        );
            ...
            super::plan_list_case_pattern(
                gleam_compiler_core::ast::Pattern::Constructor {
                    ...
                    arguments: vec![gleam_compiler_core::ast::CallArg {
                        label: None,
                        location: dummy_span(),
                        value: gleam_compiler_core::ast::Pattern::BitArraySize(
                            gleam_compiler_core::ast::BitArraySize::Int {
                                location: dummy_span(),
                                value: "1".into(),
                                int_value: 1.into(),
                            },
    ...
    fn known_constructor(
        ...
        module: &str,
        index: u16,
    ) -> gleam_compiler_core::analyse::Inferred<gleam_compiler_core::type_::PatternConstructor>
    {
        gleam_compiler_core::analyse::Inferred::Known(
            gleam_compiler_core::type_::PatternConstructor {
                name: name.into(),
                field_map: None,
                documentation: None,
    ...
    fn invalid_bit_array_pattern() -> Pattern<std::sync::Arc<gleam_compiler_core::type_::Type>> {
        Pattern::BitArray {
            location: dummy_span(),
            segments: vec![gleam_compiler_core::ast::BitArraySegment {
                location: dummy_span(),
                ...
                options: vec![
                    gleam_compiler_core::ast::BitArrayOption::Int {
                        location: dummy_span(),
                    },
                    gleam_compiler_core::ast::BitArrayOption::Float {
                        location: dummy_span(),
                    },
                ],
                type_: gleam_compiler_core::type_::int(),
