...
mod tests {
    ...
    use gleam_compiler_core::ast::{BinOp, ClauseGuard, Constant, Pattern};
...
"#,
    ...
    fn reject_margin_guarded_bool_case_missing_patterns() {
        ...
        clauses.pop();
        clauses.push(gleam_compiler_core::ast::Clause {
            location: dummy_span(),
    ...
    fn reject_margin_bool_case_subject_type_mismatch() {
        ...
        subjects[0] = gleam_compiler_core::ast::TypedExpr::String {
            location: dummy_span(),
            type_: type_::bool(),
            value: "not bool".into(),
        };
...
"#,
    ...
    fn bool_true_guard() -> ClauseGuard<std::sync::Arc<gleam_compiler_core::type_::Type>> {
