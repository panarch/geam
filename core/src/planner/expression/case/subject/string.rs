...
use ecow::EcoString;
use gleam_compiler_core::ast::{AssignName, Pattern, TypedExpr};
...
fn prefix_bindings(
    left_side_assignment: Option<(EcoString, gleam_compiler_core::ast::SrcSpan)>,
...
mod tests {
    ...
    use gleam_compiler_core::ast::{ClauseGuard, Constant, Pattern, TypedModule};
    use gleam_compiler_core::exhaustiveness::{Body, Decision};
