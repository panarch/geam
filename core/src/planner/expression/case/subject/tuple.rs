...
use ecow::EcoString;
use gleam_compiler_core::ast::{AssignName, Pattern, SrcSpan, TypedExpr};
...
mod tests {
    ...
    use gleam_compiler_core::ast::{AssignName, Pattern};
...
"#,
    ...
    ) -> &mut Vec<Pattern<std::sync::Arc<gleam_compiler_core::type_::Type>>> {
...
"#,
        ...
        clauses[0].pattern[0] = Pattern::Invalid {
            location: dummy_span(),
            type_: gleam_compiler_core::type_::tuple(vec![
