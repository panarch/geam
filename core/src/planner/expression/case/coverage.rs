...
use gleam_compiler_core::ast::TypedClause;
use gleam_compiler_core::exhaustiveness::{CompiledCase, Decision, FallbackCheck};
...
mod tests {
    ...
    use gleam_compiler_core::ast::{Statement, TypedClause, TypedExpr};
    use gleam_compiler_core::exhaustiveness::{Body, CompiledCase, Decision};
...
"#,
    ...
    ) -> &mut Vec<(gleam_compiler_core::exhaustiveness::RuntimeCheck, Decision)> {
