...
use ecow::EcoString;
use gleam_compiler_core::ast::{CallArg, TypedExpr};
...
mod tests {
    ...
    use gleam_compiler_core::ast::{
        CallArg, ImplicitCallArgOrigin, Statement, TypedExpr, TypedStatement,
    };
    use gleam_compiler_core::type_::error::{VariableDeclaration, VariableOrigin, VariableSyntax};
    ...
    fn reject_margin_record_update_non_constructor_module_select() {
        ...
        *constructor = TypedExpr::ModuleSelect {
            ...
            constructor: ModuleValueConstructor::Constant {
                literal: gleam_compiler_core::ast::Constant::Int {
                    location: dummy_span(),
                    value: "1".into(),
                    int_value: 1.into(),
                },
