...
use ecow::EcoString;
use gleam_compiler_core::ast::{CallArg as GleamCallArg, SrcSpan, TypedExpr};
...
mod support {
    ...
    use gleam_compiler_core::ast::{CallArg, Statement, TypedExpr, TypedStatement};
    use gleam_compiler_core::type_::{self, ValueConstructor};
