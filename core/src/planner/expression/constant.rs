...
use gleam_compiler_core::type_::{
    PRELUDE_MODULE_NAME, Type, ValueConstructor, ValueConstructorVariant,
};
use std::sync::Arc;
...
"#;
    ...
    fn plan_constant_segment_record_preserves_concrete_result_payload() {
        ...
        assert_eq!(
            plan_record(
                Some(vec![gleam_compiler_core::ast::CallArg {
                    label: None,
                    location: dummy_span(),
                    value: Constant::Int {
                        location: dummy_span(),
...
"#,
    ...
    fn reject_margin_invalid_constant_shapes() {
        ...
        assert_eq!(
            plan_constant_literal(Constant::Record {
                ...
                module: None,
                name: "Boxed".into(),
                arguments: Some(vec![gleam_compiler_core::ast::CallArg {
                    label: None,
                    location: dummy_span(),
                    value: Constant::Int {
                        location: dummy_span(),
    ...
    fn constant_record_constructor_margins_preserve_exact_shape_failures() {
        ...
        let int_argument = |label| gleam_compiler_core::ast::CallArg {
            label,
            location: dummy_span(),
            value: Constant::Int {
                location: dummy_span(),
...
"#,
    ...
    fn function_constant_module() -> gleam_compiler_core::ast::TypedModule {
        compile(
            r#"
fn add_one(value: Int) {
  value + 1
...
"#,
    ...
    fn module_fn_constant_alias_module_mut(
        module: &mut gleam_compiler_core::ast::TypedModule,
    ) -> &mut ecow::EcoString {
